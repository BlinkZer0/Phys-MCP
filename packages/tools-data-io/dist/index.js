 ...
 */
import { dataImportHdf5Schema, dataImportFitsSchema, dataImportRootSchema, dataExportHdf5Schema } from './schema.js';
import { dataImportHdf5Handler, dataImportFitsHandler, dataImportRootHandler, dataExportHdf5Handler } from './handlers.js';
export const tools = [
    {
...
export async function handleDataIOTool(name, args) {
