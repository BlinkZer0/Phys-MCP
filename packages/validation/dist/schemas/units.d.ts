 ...
 */
export declare const UnitsConvertInputSchema: any;
/**
 * Units smart evaluation input schema
 */
export declare const UnitsSmartEvalInputSchema: any;
/**
 * Type inference
 */
